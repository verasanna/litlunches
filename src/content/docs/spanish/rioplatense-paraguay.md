...
This list focuses on fiction written in Rioplatense Spanish (Argentina and Uruguay) and selected Paraguayan texts where relevant, prioritizing works that are both accessible in language and representative of the region’s literary register. Readability is assessed alongside actual reader experience rather than intuition alone.
